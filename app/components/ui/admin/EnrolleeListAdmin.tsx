                ...
                <ul role="list" className="divide-y divide-neutral-800">
                    <>
                        {enrollees.map((enrollee) => (
                            <li key={enrollee.id} className="py-3 sm:py-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:dark:text-white text-primary-dark"></div>
                                </div>
                            </li>
                        ))}
                    </>
